            ...
            <div class="p-8">
              <div class="space-y-6">
                <div
                  ...
                  :key="item.service"
                  class="flex flex-col md:flex-row md:items-center md:justify-between p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition-colors"
                >
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            ...
            :key="option.title"
            class="bg-gradient-to-br from-blue-50 to-emerald-50 p-8 rounded-xl border border-blue-100"
          >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div
            ...
            :key="item.label"
            class="bg-white p-6 rounded-xl shadow-lg text-center border-2 border-blue-100 hover:border-blue-300 transition-colors"
          >
